...
void theSalesmanProblem(){
    ...
    /* Función que se encarga de conseguir el circuito hamiltoniano mas corto para un problema */
    ...
    cout << "El camino mas corto es : 1 ";
    getPath(0, rowMax - 2);
    cout << "1\nCon un peso de: " << result << endl;
...
int compute( int start, int set ){
    ...
    for( int i = 0; i < n; i++ ){
        ...
        if( masked != set ){
            ...
            /* La distancia desde la ciudad start hasta la i + el camino de la ciudad i */
